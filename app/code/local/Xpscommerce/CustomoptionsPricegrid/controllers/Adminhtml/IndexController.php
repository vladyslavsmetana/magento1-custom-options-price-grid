...
class Xpscommerce_CustomoptionsPricegrid_Adminhtml_IndexController 
  extends Mage_Adminhtml_Controller_action
{
    ...
    protected function _initAction() {
        $this->loadLayout()
             ...
             ->_addBreadcrumb(Mage::helper('adminhtml')->__('Custom Options Price Grid'), 
                    Mage::helper('adminhtml')->__('Catalog / Custom Options Price Grid'));
